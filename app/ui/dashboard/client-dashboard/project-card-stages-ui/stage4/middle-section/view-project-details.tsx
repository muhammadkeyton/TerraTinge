...
export default function ViewProjectDetails({appName,appCostAndFee,paymentAmount,appDetail,paymentStatus,promo,discountedAppCostAndFee}:ViewProjectDetails){
    ...
    return(
                   ...
                   <MuiServerProvider>
                    <DialogTrigger asChild>
                        ...
                        <Button variant='text' className={`${montserrat.className} p-3 mb-4 text-indigo-600 dark:text-indigo-500`}>
