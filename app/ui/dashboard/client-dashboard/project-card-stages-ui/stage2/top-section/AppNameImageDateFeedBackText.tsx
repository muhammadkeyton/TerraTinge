...
export default function AppNameImageDateFeedBackText({appName,createdAt,appCost}:AppNameImageDateFeedBackTextProps){
    return(
        <>
            <div>
                ...
                <code className="text-xs bg-indigo-700  text-white p-1 rounded-sm">{(appCost/100).toLocaleString()} USD</code>
