...
export default function EditProject({appName,appDetail,appCost,percentage,projectId}:{appName:string,appDetail:string,projectId:string,appCost:string,percentage:string}){
