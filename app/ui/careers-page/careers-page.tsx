...
export default function CareersPage(){
    return(
        ...
        <div className="flex flex-col justify-center items-center min-h-screen px-4 lg:px-24 mb-10">
            ...
            <h2 className=" text-xl font-semibold mt-10">Looking To Join Our Team Of Engineers? <span> <code className="text-xs bg-slate-200  text-indigo-600 dark:text-indigo-700 p-1 rounded-sm"> We&apos;re not Hiring Now</code></span></h2>
